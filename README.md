...
| ![Courbe ROC](screenshots/ROC.png) | **AUC ≈ 0.97** (excellente séparation globale).<br>Au point métier **@ ~1% FPR**, on lit **TPR ≈ 0.893**. <br> En données rares, privilégier la **PR-AUC** pour la sélection de modèle. |
